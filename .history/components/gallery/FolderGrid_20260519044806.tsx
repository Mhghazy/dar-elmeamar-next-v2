...
const FolderGrid = ({ folders, onSelect, ui }: FolderGridProps) => {
  return (
    <motion.div
      ...
      className="flex md:grid z-50 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 lg:gap-16 overflow-x-auto md:overflow-x-visible pb-12 md:pb-0 snap-x snap-mandatory scrollbar-hide"
    >
